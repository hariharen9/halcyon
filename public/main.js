;(() => {
  ...
  class f {
    ...
    appear() {
      ;(this.time = 0),
        m.to(this.visibility, { value: 1 }, { duration: 2, ease: 'easeInExpo' })
    }
    onPreloaded() {
      this.appear()
    }
  ...
  class C {
    ...
    onUpdate(t) {
      ...
      let e = ''
      for (let t = 0; t < this.progress.questionMarks; t++) e += 's'
      this.four.textContent = `Graphic${e}`
    }
  }
  let F = null
  class U extends s {
  ...
  class q {
    ...
    draw() {
      this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height),
        ...
        (this.text = this.ctx.measureText('Challenges')),
